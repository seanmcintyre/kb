...
function onClick() {
    const themeCurrent = document.body.dataset.theme;
    const themeIndex = themes.indexOf(themeCurrent);
    const themeNext = themeIndex === themes.length - 1 ? themes[0] : themes[themeIndex + 1];
...
//# sourceMappingURL=_03b2798f._.js.map